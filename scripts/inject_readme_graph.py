...
_END = "<!-- END_CGIS_GRAPH -->"
_SELF_DOC_NOTE = "> *Auto-generated by CGIS parsing its own source — the tool documents itself.*\n"


def _repo_url() -> str:
    try:
        raw = subprocess.check_output(["git", "remote", "get-url", "origin"], text=True).strip()
...
def _node_table(db: str, fqn: str, depth: int, repo_url: str, path_prefix: str) -> str:
...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--path-prefix",
        default="",
        help="Prefix prepended to file paths in GitHub links (e.g. 'src/')",
    )
